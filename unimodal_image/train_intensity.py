...
from models.cnn import CNN
from models.classifier_onlyimage import Classifier_Intensity
#-----
...
def train_loop(trn_idx, val_idx):
    ...
    #     , CFG.train_path, None, None, transform=get_transforms(data = 'train'), task='intensity') 
    ...
    train_data = MemoDataset_Emotion(train_images, None, humour_y, sarcasm_y, offensive_y, motivational_y \
        , CFG.train_path, None, None, transform=get_transforms(data = 'train'), task='intensity') 
        ...
        with torch.no_grad():
            ...
            if best_wise_average_macro_f1 < current_macro_average:
                ...
                torch.save({'model': model.state_dict(), 
                        ...
                        f'onlyimage_fold{train_fold}_intensity_best.pth')
